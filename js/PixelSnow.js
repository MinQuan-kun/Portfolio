...
class PixelSnow {
  ...
  init() {
    ...
    const threeColor = new Color(this.options.color);
    const colorVector = new Vector3(threeColor.r, threeColor.g, threeColor.b);
    ...
    this.resize = () => {
      ...
      const wCSS = this.container.offsetWidth || window.innerWidth;
      const hCSS = this.container.offsetHeight || window.innerHeight;
      this.renderer.setSize(wCSS, hCSS);
      this.material.uniforms.uResolution.value.set(wCSS, hCSS);
    };
